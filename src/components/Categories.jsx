    ...
    <div className="my-12 md:px-32 flex flex-col-reverse md:flex-row gap-4">
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-2 gap-4">
        <p
          ...
          className="flex flex-col md:flex-row gap-2 text-hero-color items-center md:gap-7 text-center md:text-start"
        >
      ...
      <div className=" space-y-3 text-center md:text-start md:w-[350px]">
        <h1
          data-aos="fade-up"
          data-aos-anchor-placement="bottom-bottom"
          className="text-2xl font-medium text-hero-color"
        >
          GET ACCESS OVER
        </h1>
        <h1
          data-aos="fade-up"
          data-aos-anchor-placement="bottom-bottom"
          className="text-4xl font-bold text-[#2FA5FB]"
        >
