          ...
          <div className="flex justify-center flex-col md:flex-row items-center gap-8 lg:px-32 px-2">
            ...
            <div className="flex-1 flex flex-col gap-1">
              ...
              >
                ...
                <div className="collapse-content">
                  <p className="font-light">
                    Before listing the property, its essential to prepare it for
                    sale. This includes cleaning, decluttering, and possibly
                    making any necessary repairs or improvements to enhance its
              ...
              >
                ...
                <div className="collapse-content">
                  <p className="font-light">
                    Our sales commission varies depending on the specifics of
                    the property and the services required. We offer competitive
                    rates tailored to meet our clients needs. Contact us for a
                    personalized quote.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                <div className="collapse-content">
                  <p className="font-light">
                    Upon successful completion of the sale, your proceeds will
                    typically be disbursed through a secure method such as a
                    cashiers check or wire transfer. We`ll work closely with you
                    to ensure a smooth and timely transaction.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="collapse-content">
                  <p className="font-light">
                    The first step in buying a house is typically to assess your
                    financial situation and determine your budget. You may want
                    to get pre-approved for a mortgage to understand how much
                    you can afford to spend. Additionally, consider your
                    preferences and priorities for a home, such as location,
                    size, and amenities. Once you have a clear idea of your
                    requirements and budget, you can start searching for
                    properties and engaging with real estate professionals to
